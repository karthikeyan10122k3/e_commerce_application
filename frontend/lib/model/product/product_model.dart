...
List<Product> sampleProducts = [
  ...
  Product(
    ...
    sku: "MVCFH27F",
    weight: 3,
    dimensions: Dimensions(width: 12.42, height: 8.63, depth: 29.13),
  ...
  Product(
    ...
    sku: "9EN8WLT2",
    weight: 8,
    dimensions: Dimensions(width: 24.16, height: 10.7, depth: 11.07),
  ...
  Product(
    ...
    sku: "O5IF1NTA",
    weight: 5,
    dimensions: Dimensions(width: 14.37, height: 13.94, depth: 14.6),
  ...
  Product(
    ...
    sku: "YUIIIP4W",
    weight: 9,
    dimensions: Dimensions(width: 8.11, height: 10.89, depth: 29.06),
    warrantyInformation: "1 year warranty",
  ...
  Product(
    ...
    sku: "K71HBCGS",
    weight: 4,
    dimensions: Dimensions(width: 21.27, height: 28, depth: 11.89),
  ...
  Product(
    ...
    sku: "E70NB03B",
    weight: 10,
    dimensions: Dimensions(width: 21.51, height: 7, depth: 26.51),
    warrantyInformation: "Lifetime warranty",
    shippingInformation: "Ships in 2 weeks",
    availabilityStatus: "In Stock",
    reviews: [
